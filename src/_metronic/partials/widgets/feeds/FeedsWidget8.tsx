...
const FeedsWidget8: React.FC<Props> = ({ className }) => {
            ...
            <div className={`${className}`}>
              <div className="card-body pb-0">
                ...
                <ul className="fs-4 fw-semibold">
                  <Link to="/overview/rs2/projectRS2" style={{ color: '#000000' }}>
                    <li className="border-bottom border-2 border-gray list-unstyled py-3 fw-normal font-monospace">RSU Kasih Bunda</li>
                  </Link>
                </ul>
              </div>
            </div>
