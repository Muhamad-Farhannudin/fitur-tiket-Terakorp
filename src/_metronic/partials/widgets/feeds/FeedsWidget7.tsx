        ...
        <div className="tab-content">
          <div className={clsx("tab-pane", {active: tab === 'Overview'})}>
            <div className="card-body pb-0">
              ...
              <ul>
                <li className="border-bottom border-2 border-gray fs-3 fw-normal font-monospace">RS Al Islam Bandung</li>
              </ul>
            </div>
            ...
            <div className={`${className}`}>
              <div className="card-body pb-0">
                ...
                <ul className="fs-4 fw-semibold">
                  <Link to="/overview/rs1/projectRS1" style={{ color: '#000000' }}>
                    <li className="border-bottom border-2 border-gray list-unstyled py-3 fw-normal font-monospace">RS Al Islam Bandung</li>
                  </Link>
                </ul>
              </div>
            </div>
