...
class PasswordMeterComponent {
    constructor(_element, _options, _queries) {
        ...
        Object.defineProperty(this, "visibilityElement", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "highlightElement", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "checkSteps", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
...
// Static methods
Object.defineProperty(PasswordMeterComponent, "getInstance", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: (el, componentName = defaultPasswordMeterQueires.componentName) => {
...
Object.defineProperty(PasswordMeterComponent, "createInstances", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: (selector = defaultPasswordMeterQueires.instanseQuery, options = defaultPasswordMeterOptions, queries = defaultPasswordMeterQueires) => {
...
Object.defineProperty(PasswordMeterComponent, "createInsance", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: (selector = defaultPasswordMeterQueires.instanseQuery, options = defaultPasswordMeterOptions, queries = defaultPasswordMeterQueires) => {
...
Object.defineProperty(PasswordMeterComponent, "bootstrap", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: (selector = defaultPasswordMeterQueires.instanseQuery) => {
        PasswordMeterComponent.createInstances(selector);
    }
});
Object.defineProperty(PasswordMeterComponent, "reinitialization", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: (selector = defaultPasswordMeterQueires.instanseQuery) => {
